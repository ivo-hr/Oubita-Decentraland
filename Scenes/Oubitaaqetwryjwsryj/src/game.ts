...
barm.addComponentOrReplace(transform51)
...
barm2.addComponentOrReplace(transform52)
...
barm2.addComponentOrReplace(gltfShape38)
...
bargreen.addComponentOrReplace(transform53)
...
bargreen.addComponentOrReplace(gltfShape39)
...
bargreen2.addComponentOrReplace(transform54)
...
bargreen2.addComponentOrReplace(gltfShape40)
...
concreteroundedtable.addComponentOrReplace(transform55)
...
concreteroundedtable.addComponentOrReplace(gltfShape41)
...
concreteroundedtable2.addComponentOrReplace(transform56)
...
concreteroundedtable2.addComponentOrReplace(gltfShape42)
...
concreteroundedtable23.addComponentOrReplace(transform57)
...
concreteroundedtable23.addComponentOrReplace(gltfShape43)
...
concreteroundedtable234.addComponentOrReplace(transform58)
...
concreteroundedtable234.addComponentOrReplace(gltfShape44)
...
concreteroundedtable2345.addComponentOrReplace(transform59)
...
concreteroundedtable2345.addComponentOrReplace(gltfShape45)
...
concreteroundedtable23456.addComponentOrReplace(transform60)
...
concreteroundedtable23456.addComponentOrReplace(gltfShape46)
...
concreteroundedtable234567.addComponentOrReplace(transform61)
...
concreteroundedtable234567.addComponentOrReplace(gltfShape47)
...
funkyfloorlight.addComponentOrReplace(transform62)
...
funkyfloorlight2.addComponentOrReplace(transform63)
...
funkyfloorlight23.addComponentOrReplace(transform64)
...
funkyfloorlight234.addComponentOrReplace(transform65)
...
funkyfloorlight2345.addComponentOrReplace(transform66)
...
funkyfloorlight23456.addComponentOrReplace(transform67)
...
tablelamplight.addComponentOrReplace(transform68)
...
tablelamplight2.addComponentOrReplace(transform69)
...
tablelamplight23.addComponentOrReplace(transform70)
...
tablelamplight234.addComponentOrReplace(transform71)
...
tablelamplight2345.addComponentOrReplace(transform72)
...
tablelamplight23456.addComponentOrReplace(transform73)
...
tablelamplight234567.addComponentOrReplace(transform74)
...
rainlight.addComponentOrReplace(transform75)
...
rainlight2.addComponentOrReplace(transform76)
...
imagefromurl.addComponentOrReplace(transform77)
...
nftpictureframe23456789.addComponentOrReplace(transform78)
...
nftpictureframe234567891011121314151617.addComponentOrReplace(transform79)
...
nftpictureframe23456789101112131415161718192021.addComponentOrReplace(transform80)
...
nftpictureframe23456789101112131415161718192021222324.addComponentOrReplace(transform81)
...
wallplainblack.addComponentOrReplace(transform82)
...
wallplainblack.addComponentOrReplace(gltfShape48)
...
wallplainblack2.addComponentOrReplace(transform83)
...
wallplainblack23.addComponentOrReplace(transform84)
...
wallplainblack23.addComponentOrReplace(gltfShape50)
...
wallplainblack234.addComponentOrReplace(transform85)
...
wallplainblack234.addComponentOrReplace(gltfShape51)
...
wallplainblack2345.addComponentOrReplace(transform86)
...
wallplainblack2345.addComponentOrReplace(gltfShape52)
...
wallplainblack23456.addComponentOrReplace(transform87)
...
wallplainblack23456.addComponentOrReplace(gltfShape53)
...
nftpictureframe2345678910111213141516171819202122232425262728293031.addComponentOrReplace(transform88)
...
nftpictureframe2345678910111213141516171819202122232425262728293031323334.addComponentOrReplace(transform89)
...
doorframeblack.addComponentOrReplace(transform90)
const gltfShape54 = new GLTFShape("fb7c3a1e-aaf1-4bb1-baa1-0e0f57ed9b3f/BlackDoorframe.glb")
gltfShape54.withCollisions = true
gltfShape54.isPointerBlocker = true
gltfShape54.visible = true
doorframeblack.addComponentOrReplace(gltfShape54)

const gallerylight = new Entity('gallerylight')
engine.addEntity(gallerylight)
gallerylight.setParent(_scene)
const transform91 = new Transform({
  position: new Vector3(17.16354751586914, 54.875, 21.34850311279297),
  rotation: new Quaternion(0, 0, -8.940696716308594e-8, 1),
  scale: new Vector3(6.75, 2.25, 1.5)
})
gallerylight.addComponentOrReplace(transform91)
...
gallerylight2.addComponentOrReplace(transform92)
...
ringwhitelight.addComponentOrReplace(transform93)
const gltfShape55 = new GLTFShape("d4837726-ae7f-4ca9-9886-677094735f82/Ring_White_Light.glb")
gltfShape55.withCollisions = true
gltfShape55.isPointerBlocker = true
gltfShape55.visible = true
ringwhitelight.addComponentOrReplace(gltfShape55)
...
spotlight.addComponentOrReplace(transform94)
...
spotlight.addComponentOrReplace(gltfShape56)
...
spotlight2.addComponentOrReplace(transform95)
...
spotlight2.addComponentOrReplace(gltfShape57)
...
spotlight23.addComponentOrReplace(transform96)
...
spotlight23.addComponentOrReplace(gltfShape58)
...
spotlight234.addComponentOrReplace(transform97)
...
spotlight234.addComponentOrReplace(gltfShape59)
...
nftpictureframe23456789101112131415161718192021222324252627282930313233343536373839.addComponentOrReplace(transform98)
...
nftpictureframe2345678910111213141516171819202122232425262728293031323334353637383940414243444546.addComponentOrReplace(transform99)
...
nftpictureframe2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849.addComponentOrReplace(transform100)
...
nftpictureframe2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152.addComponentOrReplace(transform101)
...
nftpictureframe234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253.addComponentOrReplace(transform102)
...
nftpictureframe23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354.addComponentOrReplace(transform103)
...
wallcorrugatedmetal.addComponentOrReplace(transform104)
const gltfShape60 = new GLTFShape("ed5d1431-0172-4730-b81c-856fc44043f7/CorrugatedMetalWall.glb")
gltfShape60.withCollisions = true
gltfShape60.isPointerBlocker = true
gltfShape60.visible = true
wallcorrugatedmetal.addComponentOrReplace(gltfShape60)
...
wallcorrugatedmetal2.addComponentOrReplace(transform105)
...
wallcorrugatedmetal2.addComponentOrReplace(gltfShape61)
...
wallcorrugatedmetal23.addComponentOrReplace(transform106)
...
wallcorrugatedmetal23.addComponentOrReplace(gltfShape62)
...
wallcorrugatedmetal234.addComponentOrReplace(transform107)
...
wallcorrugatedmetal234.addComponentOrReplace(gltfShape63)
...
wallcorrugatedmetal2345.addComponentOrReplace(transform108)
...
wallcorrugatedmetal2345.addComponentOrReplace(gltfShape64)
...
wallcorrugatedmetal23456.addComponentOrReplace(transform109)
...
wallcorrugatedmetal23456.addComponentOrReplace(gltfShape65)
...
wallcorrugatedmetal234567.addComponentOrReplace(transform110)
...
wallcorrugatedmetal234567.addComponentOrReplace(gltfShape66)
...
wallcorrugatedmetal2345678.addComponentOrReplace(transform111)
...
wallcorrugatedmetal2345678.addComponentOrReplace(gltfShape67)
...
wallcorrugatedmetal23456789.addComponentOrReplace(transform112)
...
wallcorrugatedmetal23456789.addComponentOrReplace(gltfShape68)
...
wallcorrugatedmetal2345678910.addComponentOrReplace(transform113)
...
wallcorrugatedmetal2345678910.addComponentOrReplace(gltfShape69)
...
wallcorrugatedmetal234567891011.addComponentOrReplace(transform114)
...
wallcorrugatedmetal234567891011.addComponentOrReplace(gltfShape70)
...
wallcorrugatedmetal23456789101112.addComponentOrReplace(transform115)
...
wallcorrugatedmetal23456789101112.addComponentOrReplace(gltfShape71)
...
wallcorrugatedmetal2345678910111213.addComponentOrReplace(transform116)
...
wallcorrugatedmetal2345678910111213.addComponentOrReplace(gltfShape72)
...
wallcorrugatedmetal234567891011121314.addComponentOrReplace(transform117)
...
wallcorrugatedmetal234567891011121314.addComponentOrReplace(gltfShape73)
...
wallcorrugatedmetal23456789101112131415.addComponentOrReplace(transform118)
...
wallcorrugatedmetal23456789101112131415.addComponentOrReplace(gltfShape74)
...
wallcorrugatedmetal2345678910111213141516.addComponentOrReplace(transform119)
...
wallcorrugatedmetal2345678910111213141516.addComponentOrReplace(gltfShape75)
...
wallcorrugatedmetal234567891011121314151617.addComponentOrReplace(transform120)
...
wallcorrugatedmetal234567891011121314151617.addComponentOrReplace(gltfShape76)
...
wallcorrugatedmetal23456789101112131415161718.addComponentOrReplace(transform121)
...
wallcorrugatedmetal23456789101112131415161718.addComponentOrReplace(gltfShape77)
...
wallcorrugatedmetal2345678910111213141516171819.addComponentOrReplace(transform122)
...
wallcorrugatedmetal2345678910111213141516171819.addComponentOrReplace(gltfShape78)
...
wallcorrugatedmetal234567891011121314151617181920.addComponentOrReplace(transform123)
...
wallcorrugatedmetal234567891011121314151617181920.addComponentOrReplace(gltfShape79)
...
wallcorrugatedmetal23456789101112131415161718192021.addComponentOrReplace(transform124)
...
wallcorrugatedmetal23456789101112131415161718192021.addComponentOrReplace(gltfShape80)
...
wallcorrugatedmetal2345678910111213141516171819202122.addComponentOrReplace(transform125)
...
wallcorrugatedmetal2345678910111213141516171819202122.addComponentOrReplace(gltfShape81)
...
wallcorrugatedmetal234567891011121314151617181920212223.addComponentOrReplace(transform126)
...
wallcorrugatedmetal234567891011121314151617181920212223.addComponentOrReplace(gltfShape82)
...
wallcorrugatedmetal23456789101112131415161718192021222324.addComponentOrReplace(transform127)
...
wallcorrugatedmetal23456789101112131415161718192021222324.addComponentOrReplace(gltfShape83)
...
wallcorrugatedmetal2345678910111213141516171819202122232425.addComponentOrReplace(transform128)
...
wallcorrugatedmetal2345678910111213141516171819202122232425.addComponentOrReplace(gltfShape84)
...
wallcorrugatedmetal234567891011121314151617181920212223242526.addComponentOrReplace(transform129)
...
wallcorrugatedmetal234567891011121314151617181920212223242526.addComponentOrReplace(gltfShape85)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627.addComponentOrReplace(transform130)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627.addComponentOrReplace(gltfShape86)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728.addComponentOrReplace(transform131)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728.addComponentOrReplace(gltfShape87)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829.addComponentOrReplace(transform132)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829.addComponentOrReplace(gltfShape88)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930.addComponentOrReplace(transform133)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930.addComponentOrReplace(gltfShape89)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031.addComponentOrReplace(transform134)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031.addComponentOrReplace(gltfShape90)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132.addComponentOrReplace(transform135)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132.addComponentOrReplace(gltfShape91)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233.addComponentOrReplace(transform136)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233.addComponentOrReplace(gltfShape92)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334.addComponentOrReplace(transform137)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334.addComponentOrReplace(gltfShape93)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435.addComponentOrReplace(transform138)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435.addComponentOrReplace(gltfShape94)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536.addComponentOrReplace(transform139)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536.addComponentOrReplace(gltfShape95)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637.addComponentOrReplace(transform140)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637.addComponentOrReplace(gltfShape96)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738.addComponentOrReplace(transform141)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738.addComponentOrReplace(gltfShape97)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839.addComponentOrReplace(transform142)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839.addComponentOrReplace(gltfShape98)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940.addComponentOrReplace(transform143)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940.addComponentOrReplace(gltfShape99)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041.addComponentOrReplace(transform144)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041.addComponentOrReplace(gltfShape100)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142.addComponentOrReplace(transform145)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142.addComponentOrReplace(gltfShape101)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243.addComponentOrReplace(transform146)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243.addComponentOrReplace(gltfShape102)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344.addComponentOrReplace(transform147)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344.addComponentOrReplace(gltfShape103)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445.addComponentOrReplace(transform148)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445.addComponentOrReplace(gltfShape104)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546.addComponentOrReplace(transform149)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546.addComponentOrReplace(gltfShape105)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647.addComponentOrReplace(transform150)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647.addComponentOrReplace(gltfShape106)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748.addComponentOrReplace(transform151)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748.addComponentOrReplace(gltfShape107)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849.addComponentOrReplace(transform152)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849.addComponentOrReplace(gltfShape108)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950.addComponentOrReplace(transform153)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950.addComponentOrReplace(gltfShape109)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051.addComponentOrReplace(transform154)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051.addComponentOrReplace(gltfShape110)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152.addComponentOrReplace(transform155)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152.addComponentOrReplace(gltfShape111)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253.addComponentOrReplace(transform156)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253.addComponentOrReplace(gltfShape112)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354.addComponentOrReplace(transform157)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354.addComponentOrReplace(gltfShape113)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455.addComponentOrReplace(transform158)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455.addComponentOrReplace(gltfShape114)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556.addComponentOrReplace(transform159)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556.addComponentOrReplace(gltfShape115)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657.addComponentOrReplace(transform160)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657.addComponentOrReplace(gltfShape116)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758.addComponentOrReplace(transform161)
...
wallcorrugatedmetal2345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758.addComponentOrReplace(gltfShape117)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556575859.addComponentOrReplace(transform162)
...
wallcorrugatedmetal234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556575859.addComponentOrReplace(gltfShape118)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960.addComponentOrReplace(transform163)
...
wallcorrugatedmetal23456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960.addComponentOrReplace(gltfShape119)
...
garlandcurveyellow.addComponentOrReplace(transform164)
const gltfShape120 = new GLTFShape("680af140-41c7-40d9-8ce8-7648196c3caf/Garland_Curve_Yellow.glb")
gltfShape120.withCollisions = true
gltfShape120.isPointerBlocker = true
gltfShape120.visible = true
garlandcurveyellow.addComponentOrReplace(gltfShape120)
...
garlandcurvebluepurple.addComponentOrReplace(transform165)
const gltfShape121 = new GLTFShape("73186899-cf6e-4a4c-a30b-a4c21fc3e86c/Garland_Curve_Blue_Purple.glb")
gltfShape121.withCollisions = true
gltfShape121.isPointerBlocker = true
gltfShape121.visible = true
garlandcurvebluepurple.addComponentOrReplace(gltfShape121)
...
garlandcurveyellow2.addComponentOrReplace(transform166)
const gltfShape122 = new GLTFShape("680af140-41c7-40d9-8ce8-7648196c3caf/Garland_Curve_Yellow.glb")
gltfShape122.withCollisions = true
gltfShape122.isPointerBlocker = true
gltfShape122.visible = true
garlandcurveyellow2.addComponentOrReplace(gltfShape122)
...
floorblack.addComponentOrReplace(transform167)
const gltfShape123 = new GLTFShape("94bbf88f-cd93-4531-8bda-d93e8dfffb8f/BlackFloor.glb")
gltfShape123.withCollisions = true
gltfShape123.isPointerBlocker = true
gltfShape123.visible = true
floorblack.addComponentOrReplace(gltfShape123)
...
floorblack2.addComponentOrReplace(transform168)
...
floorblack2.addComponentOrReplace(gltfShape124)
...
wallcornerblack.addComponentOrReplace(transform169)
const gltfShape125 = new GLTFShape("b147f30c-9dee-4138-8ac3-3f9d1fadee5f/BlackCorner.glb")
gltfShape125.withCollisions = true
gltfShape125.isPointerBlocker = true
gltfShape125.visible = true
wallcornerblack.addComponentOrReplace(gltfShape125)
...
wallcornerblack2.addComponentOrReplace(transform170)
...
wallcornerblack2.addComponentOrReplace(gltfShape126)
...
floorblack23.addComponentOrReplace(transform171)
const gltfShape127 = new GLTFShape("94bbf88f-cd93-4531-8bda-d93e8dfffb8f/BlackFloor.glb")
gltfShape127.withCollisions = true
gltfShape127.isPointerBlocker = true
gltfShape127.visible = true
floorblack23.addComponentOrReplace(gltfShape127)
...
floorblack234.addComponentOrReplace(transform172)
...
floorblack234.addComponentOrReplace(gltfShape128)
...
floorblack2345.addComponentOrReplace(transform173)
...
floorblack2345.addComponentOrReplace(gltfShape129)
...
ropelight.addComponentOrReplace(transform174)
...
ropelight2.addComponentOrReplace(transform175)
...
floorglass23.addComponentOrReplace(transform176)
const gltfShape130 = new GLTFShape("f4a4956e-f60a-4108-82c7-41b5ebda6549/GlassFloor.glb")
gltfShape130.withCollisions = true
gltfShape130.isPointerBlocker = true
gltfShape130.visible = true
floorglass23.addComponentOrReplace(gltfShape130)
...
garlandcurveyellow23.addComponentOrReplace(transform177)
const gltfShape131 = new GLTFShape("680af140-41c7-40d9-8ce8-7648196c3caf/Garland_Curve_Yellow.glb")
gltfShape131.withCollisions = true
gltfShape131.isPointerBlocker = true
gltfShape131.visible = true
garlandcurveyellow23.addComponentOrReplace(gltfShape131)
...
garlandcurvebluepurple2.addComponentOrReplace(transform178)
const gltfShape132 = new GLTFShape("73186899-cf6e-4a4c-a30b-a4c21fc3e86c/Garland_Curve_Blue_Purple.glb")
gltfShape132.withCollisions = true
gltfShape132.isPointerBlocker = true
gltfShape132.visible = true
garlandcurvebluepurple2.addComponentOrReplace(gltfShape132)
...
bush23.addComponentOrReplace(transform179)
const gltfShape133 = new GLTFShape("b34ad4ca-db96-44fe-8fd6-86b4aa9f2218/HWN20_Bush.glb")
gltfShape133.withCollisions = true
gltfShape133.isPointerBlocker = true
gltfShape133.visible = true
bush23.addComponentOrReplace(gltfShape133)
...
bush234.addComponentOrReplace(transform180)
...
bush234.addComponentOrReplace(gltfShape134)
...
wallplainblack234567.addComponentOrReplace(transform181)
const gltfShape135 = new GLTFShape("d36f333b-c736-4db8-a5e2-6ab47d4364b9/PlainBlackWall.glb")
gltfShape135.withCollisions = true
gltfShape135.isPointerBlocker = true
gltfShape135.visible = true
wallplainblack234567.addComponentOrReplace(gltfShape135)
...
wallplainblack2345678.addComponentOrReplace(transform182)
...
wallplainblack2345678.addComponentOrReplace(gltfShape136)
...
wallplainblack23456789.addComponentOrReplace(transform183)
...
wallplainblack23456789.addComponentOrReplace(gltfShape137)
...
wallplainblack2345678910.addComponentOrReplace(transform184)
...
wallplainblack2345678910.addComponentOrReplace(gltfShape138)
...
wallplainblack234567891011.addComponentOrReplace(transform185)
...
wallplainblack234567891011.addComponentOrReplace(gltfShape139)
...
wallplainblack23456789101112.addComponentOrReplace(transform186)
...
wallplainblack23456789101112.addComponentOrReplace(gltfShape140)
...
sofamodern.addComponentOrReplace(transform187)
const gltfShape141 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape141.withCollisions = true
gltfShape141.isPointerBlocker = true
gltfShape141.visible = true
sofamodern.addComponentOrReplace(gltfShape141)
...
sofamodern2.addComponentOrReplace(transform188)
...
sofamodern2.addComponentOrReplace(gltfShape142)
...
sofamodern23.addComponentOrReplace(transform189)
...
sofamodern23.addComponentOrReplace(gltfShape143)
...
sofamodern234.addComponentOrReplace(transform190)
...
sofamodern234.addComponentOrReplace(gltfShape144)
...
sofamodern2345.addComponentOrReplace(transform191)
...
sofamodern2345.addComponentOrReplace(gltfShape145)
...
coffeetable2.addComponentOrReplace(transform192)
const gltfShape146 = new GLTFShape("b01154d9-db05-4713-ace7-692b67220bb0/Table_06/Table_06.glb")
gltfShape146.withCollisions = true
gltfShape146.isPointerBlocker = true
gltfShape146.visible = true
coffeetable2.addComponentOrReplace(gltfShape146)
...
sofamodern23456.addComponentOrReplace(transform193)
const gltfShape147 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape147.withCollisions = true
gltfShape147.isPointerBlocker = true
gltfShape147.visible = true
sofamodern23456.addComponentOrReplace(gltfShape147)
...
sofamodern234567.addComponentOrReplace(transform194)
...
sofamodern234567.addComponentOrReplace(gltfShape148)
...
sofamodern2345678.addComponentOrReplace(transform195)
...
sofamodern2345678.addComponentOrReplace(gltfShape149)
...
sofamodern23456789.addComponentOrReplace(transform196)
...
sofamodern23456789.addComponentOrReplace(gltfShape150)
...
coffeetable23.addComponentOrReplace(transform197)
const gltfShape151 = new GLTFShape("b01154d9-db05-4713-ace7-692b67220bb0/Table_06/Table_06.glb")
gltfShape151.withCollisions = true
gltfShape151.isPointerBlocker = true
gltfShape151.visible = true
coffeetable23.addComponentOrReplace(gltfShape151)
...
sofamodern2345678910.addComponentOrReplace(transform198)
const gltfShape152 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape152.withCollisions = true
gltfShape152.isPointerBlocker = true
gltfShape152.visible = true
sofamodern2345678910.addComponentOrReplace(gltfShape152)
...
sofamodern234567891011.addComponentOrReplace(transform199)
...
sofamodern234567891011.addComponentOrReplace(gltfShape153)
...
sofamodern23456789101112.addComponentOrReplace(transform200)
...
sofamodern23456789101112.addComponentOrReplace(gltfShape154)
...
sofamodern2345678910111213.addComponentOrReplace(transform201)
...
sofamodern2345678910111213.addComponentOrReplace(gltfShape155)
...
coffeetable234.addComponentOrReplace(transform202)
const gltfShape156 = new GLTFShape("b01154d9-db05-4713-ace7-692b67220bb0/Table_06/Table_06.glb")
gltfShape156.withCollisions = true
gltfShape156.isPointerBlocker = true
gltfShape156.visible = true
coffeetable234.addComponentOrReplace(gltfShape156)
...
sofamodern234567891011121314.addComponentOrReplace(transform203)
const gltfShape157 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape157.withCollisions = true
gltfShape157.isPointerBlocker = true
gltfShape157.visible = true
sofamodern234567891011121314.addComponentOrReplace(gltfShape157)
...
sofamodern23456789101112131415.addComponentOrReplace(transform204)
...
sofamodern23456789101112131415.addComponentOrReplace(gltfShape158)
...
sofamodern2345678910111213141516.addComponentOrReplace(transform205)
...
sofamodern2345678910111213141516.addComponentOrReplace(gltfShape159)
...
sofamodern234567891011121314151617.addComponentOrReplace(transform206)
...
sofamodern234567891011121314151617.addComponentOrReplace(gltfShape160)
...
coffeetable2345.addComponentOrReplace(transform207)
const gltfShape161 = new GLTFShape("b01154d9-db05-4713-ace7-692b67220bb0/Table_06/Table_06.glb")
gltfShape161.withCollisions = true
gltfShape161.isPointerBlocker = true
gltfShape161.visible = true
coffeetable2345.addComponentOrReplace(gltfShape161)
...
sofamodern23456789101112131415161718.addComponentOrReplace(transform208)
const gltfShape162 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape162.withCollisions = true
gltfShape162.isPointerBlocker = true
gltfShape162.visible = true
sofamodern23456789101112131415161718.addComponentOrReplace(gltfShape162)
...
sofamodern2345678910111213141516171819.addComponentOrReplace(transform209)
...
sofamodern2345678910111213141516171819.addComponentOrReplace(gltfShape163)
...
roofglassedges234.addComponentOrReplace(transform210)
const gltfShape164 = new GLTFShape("804c94f9-20d8-4fd3-aca0-d096cad08ff7/GlassRoof_2Edges.glb")
gltfShape164.withCollisions = true
gltfShape164.isPointerBlocker = true
gltfShape164.visible = true
roofglassedges234.addComponentOrReplace(gltfShape164)
...
rainlight23.addComponentOrReplace(transform211)
...
blockfloorlight2.addComponentOrReplace(transform212)
...
blockfloorlight23.addComponentOrReplace(transform213)
...
sofamodern234567891011121314151617181920.addComponentOrReplace(transform214)
const gltfShape165 = new GLTFShape("3fde7be8-91a4-44bc-bca2-6f4e93db40e2/ModernSofa.glb")
gltfShape165.withCollisions = true
gltfShape165.isPointerBlocker = true
gltfShape165.visible = true
sofamodern234567891011121314151617181920.addComponentOrReplace(gltfShape165)
...
sofamodern23456789101112131415161718192021.addComponentOrReplace(transform215)
...
sofamodern23456789101112131415161718192021.addComponentOrReplace(gltfShape166)
...
sofamodern2345678910111213141516171819202122.addComponentOrReplace(transform216)
...
sofamodern2345678910111213141516171819202122.addComponentOrReplace(gltfShape167)
...
sofamodern234567891011121314151617181920212223.addComponentOrReplace(transform217)
...
sofamodern234567891011121314151617181920212223.addComponentOrReplace(gltfShape168)
...
sofamodern23456789101112131415161718192021222324.addComponentOrReplace(transform218)
...
sofamodern23456789101112131415161718192021222324.addComponentOrReplace(gltfShape169)
...
sofamodern2345678910111213141516171819202122232425.addComponentOrReplace(transform219)
...
sofamodern2345678910111213141516171819202122232425.addComponentOrReplace(gltfShape170)
...
sofamodern234567891011121314151617181920212223242526.addComponentOrReplace(transform220)
...
sofamodern234567891011121314151617181920212223242526.addComponentOrReplace(gltfShape171)
...
sofamodern23456789101112131415161718192021222324252627.addComponentOrReplace(transform221)
...
sofamodern23456789101112131415161718192021222324252627.addComponentOrReplace(gltfShape172)
...
concreteroundedtable2345678.addComponentOrReplace(transform222)
const gltfShape173 = new GLTFShape("9d9c165d-3aaa-44ae-89f6-20d977122fce/Table_04/Table_04.glb")
gltfShape173.withCollisions = true
gltfShape173.isPointerBlocker = true
gltfShape173.visible = true
concreteroundedtable2345678.addComponentOrReplace(gltfShape173)
...
rainlight234.addComponentOrReplace(transform223)
...
wallplainblack2345678910111213.addComponentOrReplace(transform224)
const gltfShape174 = new GLTFShape("d36f333b-c736-4db8-a5e2-6ab47d4364b9/PlainBlackWall.glb")
gltfShape174.withCollisions = true
gltfShape174.isPointerBlocker = true
gltfShape174.visible = true
wallplainblack2345678910111213.addComponentOrReplace(gltfShape174)
...
ropelight23.addComponentOrReplace(transform225)
...
ringwhitelight2.addComponentOrReplace(transform226)
const gltfShape175 = new GLTFShape("d4837726-ae7f-4ca9-9886-677094735f82/Ring_White_Light.glb")
gltfShape175.withCollisions = true
gltfShape175.isPointerBlocker = true
gltfShape175.visible = true
ringwhitelight2.addComponentOrReplace(gltfShape175)
...
ringwhitelight23.addComponentOrReplace(transform227)
...
ringwhitelight23.addComponentOrReplace(gltfShape176)
...
ringwhitelight234.addComponentOrReplace(transform228)
...
ringwhitelight234.addComponentOrReplace(gltfShape177)
...
ringwhitelight2345.addComponentOrReplace(transform229)
...
ringwhitelight2345.addComponentOrReplace(gltfShape178)
...
const transform230 = new Transform({
  position: new Vector3(27, 74.5, 32),
  rotation: new Quaternion(6.098757075392999e-15, 6.098757075392999e-15, 0.7071068286895752, 0.7071068286895752),
  scale: new Vector3(2.000002861022949, 2.000002384185791, 1.000000238418579)
})
speakers234.addComponentOrReplace(transform230)
...
obitaSuperHyperTrimmed.addComponentOrReplace(transform231)
const gltfShape179 = new GLTFShape("ac15db56-3549-4b05-a37c-50e61fc61026/obita_super_hyper_trimmed.glb")
gltfShape179.withCollisions = true
gltfShape179.isPointerBlocker = true
gltfShape179.visible = true
obitaSuperHyperTrimmed.addComponentOrReplace(gltfShape179)
...
nftPictureFrame.addComponentOrReplace(transform232)
...
nftPictureFrame2.addComponentOrReplace(transform233)
...
const transform234 = new Transform({
  position: new Vector3(11.095813751220703, 49.5, 31.604110717773438),
  rotation: new Quaternion(-8.492664037296205e-15, -0.70710688829422, 8.429368847373553e-8, -0.7071067690849304),
  scale: new Vector3(7.000040531158447, 7, 1.0000052452087402)
})
nftPictureFrame3.addComponentOrReplace(transform234)

const galleryLight = new Entity('galleryLight')
engine.addEntity(galleryLight)
galleryLight.setParent(_scene)
const transform235 = new Transform({
  position: new Vector3(11.054786682128906, 53, 30.985076904296875),
  rotation: new Quaternion(-6.322027701344268e-8, 0.7071068286895752, -1.4751397259260557e-7, 0.7071068286895752),
  scale: new Vector3(4.500009536743164, 1.5, 1.500004768371582)
})
galleryLight.addComponentOrReplace(transform235)
...
const transform236 = new Transform({
  position: new Vector3(11.095813751220703, 49.5, 36.60411071777344),
  rotation: new Quaternion(-8.492664037296205e-15, -0.70710688829422, 8.429368847373553e-8, -0.7071067690849304),
  scale: new Vector3(7.00004243850708, 7, 1.0000054836273193)
})
nftPictureFrame4.addComponentOrReplace(transform236)

const galleryLight2 = new Entity('galleryLight2')
engine.addEntity(galleryLight2)
galleryLight2.setParent(_scene)
const transform237 = new Transform({
  position: new Vector3(11.054786682128906, 53, 35.985076904296875),
  rotation: new Quaternion(-6.322027701344268e-8, 0.7071068286895752, -1.4751397259260557e-7, 0.7071068286895752),
  scale: new Vector3(4.5000104904174805, 1.5, 1.5000052452087402)
})
galleryLight2.addComponentOrReplace(transform237)
...
speakers3.addComponentOrReplace(transform238)
